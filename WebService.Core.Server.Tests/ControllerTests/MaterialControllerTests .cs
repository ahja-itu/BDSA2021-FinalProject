...
public class MaterialControllerTests
{
    ...
    {
        var material = new CreateMaterialDTO(new CreateWeightedTagDTO[] { new("API", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { new("PHD") }, new CreateProgrammingLanguageDTO[] { new("C#") }, new CreateMediaDTO[] { new("Book") }, new CreateLanguageDTO("Danish"), "Summary", "Url", "Content", "Title", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
    ...
    {
        var material = new CreateMaterialDTO(new CreateWeightedTagDTO[] { new("API", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { new("PHD") }, new CreateProgrammingLanguageDTO[] { new("C#") }, new CreateMediaDTO[] { new("Book") }, new CreateLanguageDTO("Danish"), "Summary", "Url", "Content", "Material 2", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
    ...
    {
        var material = new CreateMaterialDTO(new CreateWeightedTagDTO[] { new("Some tag", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { }, new CreateProgrammingLanguageDTO[] { }, new CreateMediaDTO[] { }, new CreateLanguageDTO("Language"), "Summary", "Url", "Content", "Material 2", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
    ...
    {
        var searchForm = new SearchForm("Hello", new TagDTO[] { new(1, "SOLID") }, new LevelDTO[] { }, new ProgrammingLanguageDTO[] { }, new LanguageDTO[] { }, new MediaDTO[] { }, 5);
    ...
    {
        var searchForm = new SearchForm("Hello", new TagDTO[] { new(4, "DOTNET") }, new LevelDTO[] { }, new ProgrammingLanguageDTO[] { }, new LanguageDTO[] { }, new MediaDTO[] { }, 10);
        var response = await _materialController.Post(searchForm);
    ...
    {
        var material = new MaterialDTO(1, new CreateWeightedTagDTO[] { new("API", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { new("PHD") }, new CreateProgrammingLanguageDTO[] { new("C#") }, new CreateMediaDTO[] { new("Book") }, new CreateLanguageDTO("Danish"), "Summary", "Url", "Content", "Title new", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
    ...
    {
        var material = new MaterialDTO(1, new CreateWeightedTagDTO[] { new("API", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { new("PHD") }, new CreateProgrammingLanguageDTO[] { new("C#") }, new CreateMediaDTO[] { new("Book") }, new CreateLanguageDTO("Danish"), "Summary", "Url", "Content", "Material 2", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
        var response = await _materialController.Put(material);
    ...
    {
        var material = new MaterialDTO(1, new CreateWeightedTagDTO[] { new("Some tag", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { }, new CreateProgrammingLanguageDTO[] { }, new CreateMediaDTO[] { }, new CreateLanguageDTO("Language"), "Summary", "Url", "Content", "Material 2", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
        var response = await _materialController.Put(material);
    ...
    {
        var material = new MaterialDTO(4, new CreateWeightedTagDTO[] { new("API", 10) }, new CreateRatingDTO[] { }, new CreateLevelDTO[] { new("PHD") }, new CreateProgrammingLanguageDTO[] { new("C#") }, new CreateMediaDTO[] { new("Book") }, new CreateLanguageDTO("Danish"), "Summary", "Url", "Content", "Title new", new CreateAuthorDTO[] { }, System.DateTime.UtcNow);
        var response = await _materialController.Put(material);
        var actual = response as NotFoundResult;
